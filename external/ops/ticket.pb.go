...
const (
	...
	OpsTicketOperation_OPS_TICKET_OPERATION_APPROVE_CREATION   OpsTicketOperation = 2
	OpsTicketOperation_OPS_TICKET_OPERATION_REFUND_BALANCE     OpsTicketOperation = 3
	OpsTicketOperation_OPS_TICKET_OPERATION_MATCH_ORDER        OpsTicketOperation = 4
	OpsTicketOperation_OPS_TICKET_OPERATION_RECREATE_ORDER     OpsTicketOperation = 5
	OpsTicketOperation_OPS_TICKET_OPERATION_ORDER_NOTIFICATION OpsTicketOperation = 6
	OpsTicketOperation_OPS_TICKET_OPERATION_DROP_ORDER         OpsTicketOperation = 7
	OpsTicketOperation_OPS_TICKET_OPERATION_CREATE_TRANSFER    OpsTicketOperation = 8
	OpsTicketOperation_OPS_TICKET_OPERATION_PROCESS_TRANSFER   OpsTicketOperation = 9
)
...
var (
	OpsTicketOperation_name = map[int32]string{
		...
		2: "OPS_TICKET_OPERATION_APPROVE_CREATION",
		3: "OPS_TICKET_OPERATION_REFUND_BALANCE",
		4: "OPS_TICKET_OPERATION_MATCH_ORDER",
		5: "OPS_TICKET_OPERATION_RECREATE_ORDER",
		6: "OPS_TICKET_OPERATION_ORDER_NOTIFICATION",
		7: "OPS_TICKET_OPERATION_DROP_ORDER",
		8: "OPS_TICKET_OPERATION_CREATE_TRANSFER",
		9: "OPS_TICKET_OPERATION_PROCESS_TRANSFER",
	}
	OpsTicketOperation_value = map[string]int32{
		"OPS_TICKET_OPERATION_ORDER_CREATION":     0,
		"OPS_TICKET_OPERATION_LOCK_BALANCE":       1,
		"OPS_TICKET_OPERATION_APPROVE_CREATION":   2,
		"OPS_TICKET_OPERATION_REFUND_BALANCE":     3,
		"OPS_TICKET_OPERATION_MATCH_ORDER":        4,
		"OPS_TICKET_OPERATION_RECREATE_ORDER":     5,
		"OPS_TICKET_OPERATION_ORDER_NOTIFICATION": 6,
		"OPS_TICKET_OPERATION_DROP_ORDER":         7,
		"OPS_TICKET_OPERATION_CREATE_TRANSFER":    8,
		"OPS_TICKET_OPERATION_PROCESS_TRANSFER":   9,
	}
)
...
const (
	...
	OpsTicketState_OPS_TICKET_STATE_PROCESSED OpsTicketState = 2
)
...
var file_ticket_proto_rawDesc = []byte{
	...
	0x4f, 0x50, 0x53, 0x22, 0xe2, 0x01, 0x0a, 0x06, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x1b,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x72,
	...
	,
}
